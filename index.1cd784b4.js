 ...
 * limitations under the License.
 */
const Vr="firebase-heartbeat-database",Gr=1,Xr="firebase-heartbeat-store";let Jr=null;function Kr(){return Jr||(Jr=Er(Vr,Gr,{upgrade:(e,t)=>{if(0===t)e.createObjectStore(Xr)}}).catch((e=>{throw Br.create("idb-open",{originalErrorMessage:e.message})}))),Jr}async function Yr(e,t){try{const n=(await Kr()).transaction(Xr,"readwrite"),i=n.objectStore(Xr);return await i.put(t,Qr(e)),n.done}catch(e){if(e instanceof Ti)Or.warn(e.message);else{const t=Br.create("idb-set",{originalErrorMessage:null==e?void 0:e.message});Or.warn(t.message)}}}function Qr(e){return`${e.name}!${e.options.appId}`}
/**
 * @license
 * Copyright 2021 Google LLC
 *
 ...
 * limitations under the License.
 */
Hr("firebase","9.19.1","app");Zn=o("6qd2L");const ro="@firebase/database",oo="0.14.4";
/**
 * @license
 * Copyright 2019 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Jo{constructor(){this.counters_={}}incrementCounter(e,t=1){ji(this.counters_,e)||(this.counters_[e]=0),this.counters_[e]+=t}get(){return hi(this.counters_)}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Ko={},Yo={};function Qo(e){const t=e.toString();return Ko[t]||(Ko[t]=new Jo),Ko[t]}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * limitations under the License.
 */
let Hs,Vs,Gs;class Xs{constructor(e,t=Xs.__childrenNodeConstructor.EMPTY_NODE){this.value_=e,this.priorityNode_=t,this.lazyHash_=null,ii(void 0!==this.value_&&null!==this.value_,"LeafNode shouldn't be created with null/undefined value."),$s(this.priorityNode_)}static set __childrenNodeConstructor(e){Hs=e}static get __childrenNodeConstructor(){return Hs}isLeafNode(){return!0}getPriority(){return this.priorityNode_}updatePriority(e){return new Xs(this.value_,e)}getImmediateChild(e){return".priority"===e?this.priorityNode_:Xs.__childrenNodeConstructor.EMPTY_NODE}getChild(e){return _s(e)?this:".priority"===ps(e)?this.priorityNode_:Xs.__childrenNodeConstructor.EMPTY_NODE}hasChild(){return!1}getPredecessorChildName(e,t){return null}updateImmediateChild(e,t){return".priority"===e?this.updatePriority(t):t.isEmpty()&&".priority"!==e?this:Xs.__childrenNodeConstructor.EMPTY_NODE.updateImmediateChild(e,t).updatePriority(this.priorityNode_)}updateChild(e,t){const n=ps(e);return null===n?t:t.isEmpty()&&".priority"!==n?this:(ii(".priority"!==n||1===ms(e),".priority must be the last token in a path"),this.updateImmediateChild(n,Xs.__childrenNodeConstructor.EMPTY_NODE.updateChild(gs(e),t)))}isEmpty(){return!1}numChildren(){return 0}forEachChild(e,t){return!1}val(e){return e&&!this.getPriority().isEmpty()?{".value":this.getValue(),".priority":this.getPriority().val()}:this.getValue()}hash(){if(null===this.lazyHash_){let e="";this.priorityNode_.isEmpty()||(e+="priority:"+qs(this.priorityNode_.val())+":");const t=typeof this.value_;e+=t+":",e+="number"===t?Lo(this.value_):this.value_,this.lazyHash_=mo(e)}return this.lazyHash_}getValue(){return this.value_}compareTo(e){return e===Xs.__childrenNodeConstructor.EMPTY_NODE?1:e instanceof Xs.__childrenNodeConstructor?-1:(ii(e.isLeafNode(),"Unknown node type"),this.compareToLeafNode_(e))}compareToLeafNode_(e){const t=typeof e.value_,n=typeof this.value_,i=Xs.VALUE_TYPE_ORDER.indexOf(t),r=Xs.VALUE_TYPE_ORDER.indexOf(n);return ii(i>=0,"Unknown leaf type: "+t),ii(r>=0,"Unknown leaf type: "+n),i===r?"object"===n?0:this.value_<e.value_?-1:this.value_===e.value_?0:1:r-i}withIndex(){return this}isIndexed(){return!0}equals(e){if(e===this)return!0;if(e.isLeafNode()){const t=e;return this.value_===t.value_&&this.priorityNode_.equals(t.priorityNode_)}return!1}}Xs.VALUE_TYPE_ORDER=["object","boolean","number","string"];const Js=new class extends Ps{compare(e,t){const n=e.node.getPriority(),i=t.node.getPriority(),r=n.compareTo(i);return 0===r?To(e.name,t.name):r}isDefinedOn(e){return!e.getPriority().isEmpty()}indexedValueChanged(e,t){return!e.getPriority().equals(t.getPriority())}minPost(){return Os.MIN}maxPost(){return new Os(Co,new Xs("[PRIORITY-POST]",Gs))}makePost(e,t){const n=Vs(e);return new Os(t,new Xs("[PRIORITY-POST]",n))}toString(){return".priority"}},Ks=Math.log(2);
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * limitations under the License.
 */
const oa=!0;function sa(e,t=null){if(null===e)return ia.EMPTY_NODE;if("object"==typeof e&&".priority"in e&&(t=e[".priority"]),ii(null===t||"string"==typeof t||"number"==typeof t||"object"==typeof t&&".sv"in t,"Invalid priority type found: "+typeof t),"object"==typeof e&&".value"in e&&null!==e[".value"]&&(e=e[".value"]),"object"!=typeof e||".sv"in e){return new Xs(e,sa(t))}if(e instanceof Array||!oa){let n=ia.EMPTY_NODE;return Po(e,((t,i)=>{if(ji(e,t)&&"."!==t.substring(0,1)){const e=sa(i);!e.isLeafNode()&&e.isEmpty()||(n=n.updateImmediateChild(t,e))}})),n.updatePriority(sa(t))}{const n=[];let i=!1;if(Po(e,((e,t)=>{if("."!==e.substring(0,1)){const r=sa(t);r.isEmpty()||(i=i||!r.getPriority().isEmpty(),n.push(new Os(e,r)))}})),0===n.length)return ia.EMPTY_NODE;const r=Qs(n,Bs,(e=>e.name),zs);if(i){const e=Qs(n,Js.getCompare());return new ia(r,sa(t),new ta({".priority":e},{".priority":Js}))}return new ia(r,sa(t),ta.Default)}}!function(e){Vs=e}(sa);
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * limitations under the License.
 */
class fa{constructor(){this.limitSet_=!1,this.startSet_=!1,this.startNameSet_=!1,this.startAfterSet_=!1,this.endSet_=!1,this.endNameSet_=!1,this.endBeforeSet_=!1,this.limit_=0,this.viewFrom_="",this.indexStartValue_=null,this.indexStartName_="",this.indexEndValue_=null,this.indexEndName_="",this.index_=Js}hasStart(){return this.startSet_}isViewFromLeft(){return""===this.viewFrom_?this.startSet_:"l"===this.viewFrom_}getIndexStartValue(){return ii(this.startSet_,"Only valid if start has been set"),this.indexStartValue_}getIndexStartName(){return ii(this.startSet_,"Only valid if start has been set"),this.startNameSet_?this.indexStartName_:Io}hasEnd(){return this.endSet_}getIndexEndValue(){return ii(this.endSet_,"Only valid if end has been set"),this.indexEndValue_}getIndexEndName(){return ii(this.endSet_,"Only valid if end has been set"),this.endNameSet_?this.indexEndName_:Co}hasLimit(){return this.limitSet_}hasAnchoredLimit(){return this.limitSet_&&""!==this.viewFrom_}getLimit(){return ii(this.limitSet_,"Only valid if limit has been set"),this.limit_}getIndex(){return this.index_}loadsAllData(){return!(this.startSet_||this.endSet_||this.limitSet_)}isDefault(){return this.loadsAllData()&&this.index_===Js}copy(){const e=new fa;return e.limitSet_=this.limitSet_,e.limit_=this.limit_,e.startSet_=this.startSet_,e.startAfterSet_=this.startAfterSet_,e.indexStartValue_=this.indexStartValue_,e.startNameSet_=this.startNameSet_,e.indexStartName_=this.indexStartName_,e.endSet_=this.endSet_,e.endBeforeSet_=this.endBeforeSet_,e.indexEndValue_=this.indexEndValue_,e.endNameSet_=this.endNameSet_,e.indexEndName_=this.indexEndName_,e.index_=this.index_,e.viewFrom_=this.viewFrom_,e}}function pa(e){const t={};if(e.isDefault())return t;let n;if(e.index_===Js?n="$priority":e.index_===ca?n="$value":e.index_===js?n="$key":(ii(e.index_ instanceof aa,"Unrecognized index type!"),n=e.index_.toString()),t.orderBy=Oi(n),e.startSet_){const n=e.startAfterSet_?"startAfter":"startAt";t[n]=Oi(e.indexStartValue_),e.startNameSet_&&(t[n]+=","+Oi(e.indexStartName_))}if(e.endSet_){const n=e.endBeforeSet_?"endBefore":"endAt";t[n]=Oi(e.indexEndValue_),e.endNameSet_&&(t[n]+=","+Oi(e.indexEndName_))}return e.limitSet_&&(e.isViewFromLeft()?t.limitToFirst=e.limit_:t.limitToLast=e.limit_),t}function ma(e){const t={};if(e.startSet_&&(t.sp=e.indexStartValue_,e.startNameSet_&&(t.sn=e.indexStartName_),t.sin=!e.startAfterSet_),e.endSet_&&(t.ep=e.indexEndValue_,e.endNameSet_&&(t.en=e.indexEndName_),t.ein=!e.endBeforeSet_),e.limitSet_){t.l=e.limit_;let n=e.viewFrom_;""===n&&(n=e.isViewFromLeft()?"l":"r"),t.vf=n}return e.index_!==Js&&(t.i=e.index_.toString()),t}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Xc{constructor(e="",t=null,n={children:{},childCount:0}){this.name=e,this.parent=t,this.node=n}}function Jc(e,t){let n=t instanceof ds?t:new ds(t),i=e,r=ps(n);for(;null!==r;){const e=Mi(i.node.children,r)||{children:{},childCount:0};i=new Xc(r,i,e),n=gs(n),r=ps(n)}return i}function Kc(e){return e.node.value}function Yc(e,t){e.node.value=t,nl(e)}function Qc(e){return e.node.childCount>0}function Zc(e,t){Po(e.node.children,((n,i)=>{t(new Xc(n,e,i))}))}function el(e,t,n,i){n&&!i&&t(e),Zc(e,(e=>{el(e,t,!0,i)})),n&&i&&t(e)}function tl(e){return new ds(null===e.parent?e.name:tl(e.parent)+"/"+e.name)}function nl(e){null!==e.parent&&function(e,t,n){const i=function(e){return void 0===Kc(e)&&!Qc(e)}(n),r=ji(e.node.children,t);i&&r?(delete e.node.children[t],e.node.childCount--,nl(e)):i||r||(e.node.children[t]=n.node,e.node.childCount++,nl(e))}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * limitations under the License.
 */
class Gl{constructor(e,t,n,i){this._repo=e,this._path=t,this._queryParams=n,this._orderByCalled=i}get key(){return _s(this._path)?null:ys(this._path)}get ref(){return new Xl(this._repo,this._path)}get _queryIdentifier(){const e=ma(this._queryParams),t=Ao(e);return"{}"===t?"default":t}get _queryObject(){return ma(this._queryParams)}isEqual(e){if(!((e=Qi(e))instanceof Gl))return!1;const t=this._repo===e._repo,n=Es(this._path,e._path),i=this._queryIdentifier===e._queryIdentifier;return t&&n&&i}toJSON(){return this.toString()}toString(){return this._repo.toString()+function(e){let t="";for(let n=e.pieceNum_;n<e.pieces_.length;n++)""!==e.pieces_[n]&&(t+="/"+encodeURIComponent(String(e.pieces_[n])));return t||"/"}(this._path)}}class Xl extends Gl{constructor(e,t){super(e,t,new fa,!1)}get parent(){const e=vs(this._path);return null===e?null:new Xl(this._repo,e)}get root(){let e=this;for(;null!==e.parent;)e=e.parent;return e}}function Jl(e,t){return(e=Qi(e))._checkNotDeleted("ref"),void 0!==t?Kl(e._root,t):e._root}function Kl(e,t){return null===ps((e=Qi(e))._path)?fl("child","path",t,!1):dl("child","path",t,!1),new Xl(e._repo,ws(e._path,t))}function Yl(e,t){e=Qi(e),pl("set",e._path),ll("set",t,e._path,!1);const n=new vi;return Al(e._repo,e._path,t,null,n.wrapCallback((()=>{}))),n.promise}function Ql(e,t){hl("update",t,e._path,!1);const n=new vi;return function(e,t,n,i){Pl(e,"update",{path:t.toString(),value:n});let r=!0;const o=Il(e),s={};if(Po(n,((n,i)=>{r=!1,s[n]=Hc(ws(t,n),sa(i),e.serverSyncTree_,o)})),r)wo("update() called with empty data.  Don't do anything."),Ll(0,i,"ok",void 0);else{const r=Rl(e),o=Tc(e.serverSyncTree_,t,s,r);yl(e.eventQueue_,o),e.server_.merge(t.toString(),n,((n,o)=>{const s="ok"===n;s||Eo("update at "+t+" failed: "+n);const a=Nc(e.serverSyncTree_,r,!s),c=a.length>0?Ml(e,t):t;bl(e.eventQueue_,c,a),Ll(0,i,n,o)})),Po(n,(n=>{const i=Wl(e,ws(t,n));Ml(e,i)})),bl(e.eventQueue_,t,[])}}(e._repo,e._path,t,n.wrapCallback((()=>{}))),n.promise}!function(e){ii(!xc,"__referenceConstructor has already been defined"),xc=e}(Xl),function(e){ii(!kc,"__referenceConstructor has already been defined"),kc=e}(Xl);
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Ju(e){const t=e.toLowerCase();if(t.includes("opera/")||t.includes("opr/")||t.includes("opios/"))return"Opera";if(Zu(t))return"IEMobile";if(t.includes("msie")||t.includes("trident/"))return"IE";if(t.includes("edge/"))return"Edge";if(Ku(t))return"Firefox";if(t.includes("silk/"))return"Silk";if(th(t))return"Blackberry";if(nh(t))return"Webos";if(Yu(t))return"Safari";if((t.includes("chrome/")||Qu(t))&&!t.includes("edge/"))return"Chrome";if(eh(t))return"Android";{const t=/([a-zA-Z\d\.]+)\/[a-zA-Z\d\.]*$/,n=e.match(t);if(2===(null==n?void 0:n.length))return n[1]}return"Other"}function Ku(e=_i()){return/firefox\//i.test(e)}function Yu(e=_i()){const t=e.toLowerCase();return t.includes("safari/")&&!t.includes("chrome/")&&!t.includes("crios/")&&!t.includes("android")}function Qu(e=_i()){return/crios\//i.test(e)}function Zu(e=_i()){return/iemobile/i.test(e)}function eh(e=_i()){return/android/i.test(e)}function th(e=_i()){return/blackberry/i.test(e)}function nh(e=_i()){return/webos/i.test(e)}function ih(e=_i()){return/iphone|ipad|ipod/i.test(e)||/macintosh/i.test(e)&&/mobile/i.test(e)}function rh(){return Si()&&10===document.documentMode}function oh(e=_i()){return ih(e)||eh(e)||nh(e)||th(e)||/windows phone/i.test(e)||Zu(e)}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * limitations under the License.
 */
function sh(e,t=[]){let n;switch(e){case"Browser":n=Ju(_i());break;case"Worker":n=`${Ju(_i())}-${e}`;break;default:n=e}const i=t.length?t.join(","):"FirebaseCore-web";return`${n}/JsCore/${Wr}/${i}`}
/**
 * @license
 * Copyright 2022 Google LLC
 *
 ...
 * limitations under the License.
 */
function Jh(){return void 0!==Xh().WorkerGlobalScope&&"function"==typeof Xh().importScripts}
/**
 * @license
 * Copyright 2019 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Pd=new ku(3e4,6e4);function Ld(){const e=Xh().___jsl;if(null==e?void 0:e.H)for(const t of Object.keys(e.H))if(e.H[t].r=e.H[t].r||[],e.H[t].L=e.H[t].L||[],e.H[t].r=[...e.H[t].L],e.CP)for(let t=0;t<e.CP.length;t++)e.CP[t]=null}let Dd=null;function jd(e){return Dd=Dd||function(e){return new Promise(((t,n)=>{var i,r,o;function s(){Ld(),gapi.load("gapi.iframes",{callback:()=>{t(gapi.iframes.getContext())},ontimeout:()=>{Ld(),n(hu(e,"network-request-failed"))},timeout:Pd.get()})}if(null===(r=null===(i=Xh().gapi)||void 0===i?void 0:i.iframes)||void 0===r?void 0:r.Iframe)t(gapi.iframes.getContext());else{if(!(null===(o=Xh().gapi)||void 0===o?void 0:o.load)){const t=ad("iframefcb");return Xh()[t]=()=>{gapi.load?s():n(hu(e,"network-request-failed"))},sd(`https://apis.google.com/js/api.js?onload=${t}`).catch((e=>n(e)))}s()}})).catch((e=>{throw Dd=null,e}))}(e),Dd}
/**
 * @license
 * Copyright 2020 Google LLC.
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */(e)}?${Wi(a).slice(1)}`}const Jd="webStorageSupport";const Kd=class{constructor(){this.eventManagers={},this.iframes={},this.originValidationPromises={},this._redirectPersistence=$h,this._completeRedirectFn=Sd,this._overrideRedirectResult=xd}async _openPopup(e,t,n,i){var r;gu(null===(r=this.eventManagers[e._key()])||void 0===r?void 0:r.manager,"_initialize() not called before _openPopup()");return Hd(e,Xd(e,t,n,vu(),i),Vh())}async _openRedirect(e,t,n,i){var r;return await this._originValidation(e),r=Xd(e,t,n,vu(),i),Xh().location.href=r,new Promise((()=>{}))}_initialize(e){const t=e._key();if(this.eventManagers[t]){const{manager:e,promise:n}=this.eventManagers[t];return e?Promise.resolve(e):(gu(n,"If manager is not set, promise should be"),n)}const n=this.initAndGetManager(e);return this.eventManagers[t]={promise:n},n.catch((()=>{delete this.eventManagers[t]})),n}async initAndGetManager(e){const t=await async function(e){const t=await jd(e),n=Xh().gapi;return pu(n,e,"internal-error"),t.open({where:document.body,url:Wd(e),messageHandlersFilter:n.iframes.CROSS_ORIGIN_IFRAMES_FILTER,attributes:Bd,dontclear:!0},(t=>new Promise((async(n,i)=>{await t.restyle({setHideOnLeave:!1});const r=hu(e,"network-request-failed"),o=Xh().setTimeout((()=>{i(r)}),Md.get());function s(){Xh().clearTimeout(o),n(t)}t.ping(s).then(s,(()=>{i(r)}))}))))}(e),n=new Id(e);return t.register("authEvent",(t=>{pu(null==t?void 0:t.authEvent,e,"invalid-auth-event");return{status:n.onEvent(t.authEvent)?"ACK":"ERROR"}}),gapi.iframes.CROSS_ORIGIN_IFRAMES_FILTER),this.eventManagers[e._key()]={manager:n},this.iframes[e._key()]=t,n}_isIframeWebStorageSupported(e,t){this.iframes[e._key()].send(Jd,{type:Jd},(n=>{var i;const r=null===(i=null==n?void 0:n[0])||void 0===i?void 0:i[Jd];void 0!==r&&t(!!r),uu(e,"internal-error")}),gapi.iframes.CROSS_ORIGIN_IFRAMES_FILTER)}_originValidation(e){const t=e._key();return this.originValidationPromises[t]||(this.originValidationPromises[t]=Ad(e)),this.originValidationPromises[t]}get _shouldInitProactively(){return oh()||Yu()||ih()}};var Yd="@firebase/auth",Qd="0.22.0";
/**
 * @license
 * Copyright 2020 Google LLC
 *
