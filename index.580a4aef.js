 ...
 * limitations under the License.
 */
const qd="pendingRedirect",$d=new Map;class Hd extends zd{constructor(e,t,n=!1){super(e,["signInViaRedirect","linkViaRedirect","reauthViaRedirect","unknown"],t,void 0,n),this.eventId=null}async execute(){let e=$d.get(this.auth._key());if(!e){try{const t=await async function(e,t){const n=Kd(t),i=Xd(e);if(!await i._isAvailable())return!1;const o="true"===await i._get(n);return await i._remove(n),o}(this.resolver,this.auth)?await super.execute():null;e=()=>Promise.resolve(t)}catch(t){e=()=>Promise.reject(t)}$d.set(this.auth._key(),e)}return this.bypassAuthState||$d.set(this.auth._key(),(()=>Promise.resolve(null))),e()}async onAuthEvent(e){if("signInViaRedirect"===e.type)return super.onAuthEvent(e);if("unknown"!==e.type){if(e.eventId){const t=await this.auth._redirectUserForId(e.eventId);if(t)return this.user=t,super.onAuthEvent(e);this.resolve(null)}}else this.resolve(null)}async onExecution(){}cleanUp(){}}function Vd(e,t){$d.set(e._key(),t)}function Xd(e){return zu(e._redirectPersistence)}function Kd(e){return mh(qd,e.config.apiKey,e.name)}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const of=new Hu(3e4,6e4);function rf(){const e=bd().___jsl;if(null==e?void 0:e.H)for(const t of Object.keys(e.H))if(e.H[t].r=e.H[t].r||[],e.H[t].L=e.H[t].L||[],e.H[t].r=[...e.H[t].L],e.CP)for(let t=0;t<e.CP.length;t++)e.CP[t]=null}let sf=null;function af(e){return sf=sf||function(e){return new Promise(((t,n)=>{var i,o,r;function s(){rf(),gapi.load("gapi.iframes",{callback:()=>{t(gapi.iframes.getContext())},ontimeout:()=>{rf(),n(Lu(e,"network-request-failed"))},timeout:of.get()})}if(null===(o=null===(i=bd().gapi)||void 0===i?void 0:i.iframes)||void 0===o?void 0:o.Iframe)t(gapi.iframes.getContext());else{if(!(null===(r=bd().gapi)||void 0===r?void 0:r.load)){const t=Ad("iframefcb");return bd()[t]=()=>{gapi.load?s():n(Lu(e,"network-request-failed"))},Rd(`https://apis.google.com/js/api.js?onload=${t}`).catch((e=>n(e)))}s()}})).catch((e=>{throw sf=null,e}))}(e),sf}
/**
 * @license
 * Copyright 2020 Google LLC.
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const lf=new Hu(5e3,15e3),cf="__/auth/iframe",uf="emulator/auth/iframe",hf={style:{position:"absolute",top:"-100px",width:"1px",height:"1px"},"aria-hidden":"true",tabindex:"-1"},df=new Map([["identitytoolkit.googleapis.com","p"],["staging-identitytoolkit.sandbox.googleapis.com","s"],["test-identitytoolkit.sandbox.googleapis.com","t"]]);function ff(e){const t=e.config;Mu(t.authDomain,e,"auth-domain-config-required");const n=t.emulator?Vu(t,uf):`https://${e.config.authDomain}/${cf}`,i={apiKey:t.apiKey,appName:e.name,v:hr},o=df.get(e.config.apiHost);o&&(i.eid=o);const r=e._getFrameworks();return r.length&&(i.fw=r.join(",")),`${n}?${uo(i).slice(1)}`}
/**
 * @license
 * Copyright 2020 Google LLC.
 *
