 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Vs{getCompare(){return this.compare.bind(this)}indexedValueChanged(e,t){const n=new $s(Bo,e),i=new $s(Bo,t);return 0!==this.compare(n,i)}minPost(){return $s.MIN}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let Dl,Ml;function Ul(e,t,n,i){const r=t.source.queryId;if(null!==r){const o=e.views.get(r);return gi(null!=o,"SyncTree gave us an op for an invalid query."),Ll(o,t,n,i)}{let r=[];for(const o of e.views.values())r=r.concat(Ll(o,t,n,i));return r}}function Fl(e,t){let n=null;for(const i of e.views.values())n=n||Ol(i,t);return n}class Bl{constructor(e){this.listenProvider_=e,this.syncPointTree_=new Ja(null),this.pendingWriteTree_={visibleWrites:Ya.empty(),allWrites:[],lastWriteId:-1},this.tagToQueryMap=new Map,this.queryToTagMap=new Map}}function zl(e,t,n,i,r){return function(e,t,n,i,r){gi(i>e.lastWriteId,"Stacking an older write on top of newer ones"),void 0===r&&(r=!0),e.allWrites.push({path:t,snap:n,writeId:i,visible:r}),r&&(e.visibleWrites=Qa(e.visibleWrites,t,n)),e.lastWriteId=i}(e.pendingWriteTree_,t,n,i,r),r?Vl(e,new za({fromUser:!0,fromServer:!1,queryId:null,tagged:!1},t,n)):[]}function jl(e,t,n,i){!function(e,t,n,i){gi(i>e.lastWriteId,"Stacking an older merge on top of newer ones"),e.allWrites.push({path:t,children:n,writeId:i,visible:!0}),e.visibleWrites=Za(e.visibleWrites,t,n),e.lastWriteId=i}(e.pendingWriteTree_,t,n,i);const r=Ja.fromObject(n);return Vl(e,new ja({fromUser:!0,fromServer:!1,queryId:null,tagged:!1},t,r))}function Wl(e,t,n=!1){const i=function(e,t){for(let n=0;n<e.allWrites.length;n++){const i=e.allWrites[n];if(i.writeId===t)return i}return null}(e.pendingWriteTree_,t);if(cl(e.pendingWriteTree_,t)){let t=new Ja(null);return null!=i.snap?t=t.set(Es(),!0):Vo(i.children,(e=>{t=t.set(new Is(e),!0)})),Vl(e,new Ba(i.path,t,n))}return[]}function Hl(e,t,n){return Vl(e,new za({fromUser:!1,fromServer:!0,queryId:null,tagged:!1},t,n))}function ql(e,t,n,i){const r=Gl(e,i);if(null!=r){const i=Jl(r),o=i.path,s=i.queryId,a=Ds(o,t);return Yl(e,o,new za(Fa(s),a,n))}return[]}function $l(e,t,n){const i=e.pendingWriteTree_,r=e.syncPointTree_.findOnPath(t,((e,n)=>{const i=Fl(n,Ds(e,t));if(i)return i}));return fl(i,t,r,n,!0)}function Vl(e,t){return Xl(t,e.syncPointTree_,null,ll(e.pendingWriteTree_,Es()))}function Xl(e,t,n,i){if(Ps(e.path))return Kl(e,t,n,i);{const r=t.get(Es());null==n&&null!=r&&(n=Fl(r,Es()));let o=[];const s=Ts(e.path),a=e.operationForChild(s),l=t.children.get(s);if(l&&a){const e=n?n.getImmediateChild(s):null,t=_l(i,s);o=o.concat(Xl(a,l,e,t))}return r&&(o=o.concat(Ul(r,e,i,n))),o}}function Kl(e,t,n,i){const r=t.get(Es());null==n&&null!=r&&(n=Fl(r,Es()));let o=[];return t.children.inorderTraversal(((t,r)=>{const s=n?n.getImmediateChild(t):null,a=_l(i,t),l=e.operationForChild(t);l&&(o=o.concat(Kl(l,r,s,a)))})),r&&(o=o.concat(Ul(r,e,i,n))),o}function Gl(e,t){return e.tagToQueryMap.get(t)}function Jl(e){const t=e.indexOf("$");return gi(-1!==t&&t<e.length-1,"Bad queryKey."),{queryId:e.substr(t+1),path:new Is(e.substr(0,t))}}function Yl(e,t,n){const i=e.syncPointTree_.get(t);gi(i,"Missing sync point for query tag that we're tracking");return Ul(i,n,ll(e.pendingWriteTree_,t),null)}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * limitations under the License.
 */
class Nc{constructor(){this.eventLists_=[],this.recursionDepth_=0}}function Rc(e,t){let n=null;for(let i=0;i<t.length;i++){const r=t[i],o=r.getPath();null===n||Us(o,n.path)||(e.eventLists_.push(n),n=null),null===n&&(n={events:[],path:o}),n.events.push(r)}n&&e.eventLists_.push(n)}function Ac(e,t,n){Rc(e,n),Oc(e,(e=>Fs(e,t)||Fs(t,e)))}function Oc(e,t){e.recursionDepth_++;let n=!0;for(let i=0;i<e.eventLists_.length;i++){const r=e.eventLists_[i];if(r){t(r.path)?(Lc(e.eventLists_[i]),e.eventLists_[i]=null):n=!1}}n&&(e.eventLists_=[]),e.recursionDepth_--}function Lc(e){for(let t=0;t<e.events.length;t++){const n=e.events[t];if(null!==n){e.events[t]=null;const i=n.getEventRunner();Ro&&Lo("event: "+n.toString()),Jo(i)}}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */(e)}?${tr(a).slice(1)}`}const cf="webStorageSupport";const uf=class{constructor(){this.eventManagers={},this.iframes={},this.originValidationPromises={},this._redirectPersistence=id,this._completeRedirectFn=Fd,this._overrideRedirectResult=Dd}async _openPopup(e,t,n,i){var r;Nu(null===(r=this.eventManagers[e._key()])||void 0===r?void 0:r.manager,"_initialize() not called before _openPopup()");return of(e,lf(e,t,n,Ou(),i),od())}async _openRedirect(e,t,n,i){var r;return await this._originValidation(e),r=lf(e,t,n,Ou(),i),ad().location.href=r,new Promise((()=>{}))}_initialize(e){const t=e._key();if(this.eventManagers[t]){const{manager:e,promise:n}=this.eventManagers[t];return e?Promise.resolve(e):(Nu(n,"If manager is not set, promise should be"),n)}const n=this.initAndGetManager(e);return this.eventManagers[t]={promise:n},n.catch((()=>{delete this.eventManagers[t]})),n}async initAndGetManager(e){const t=await async function(e){const t=await Gd(e),n=ad().gapi;return Tu(n,e,"internal-error"),t.open({where:document.body,url:tf(e),messageHandlersFilter:n.iframes.CROSS_ORIGIN_IFRAMES_FILTER,attributes:Zd,dontclear:!0},(t=>new Promise((async(n,i)=>{await t.restyle({setHideOnLeave:!1});const r=Cu(e,"network-request-failed"),o=ad().setTimeout((()=>{i(r)}),Jd.get());function s(){ad().clearTimeout(o),n(t)}t.ping(s).then(s,(()=>{i(r)}))}))))}(e),n=new Bd(e);return t.register("authEvent",(t=>{Tu(null==t?void 0:t.authEvent,e,"invalid-auth-event");return{status:n.onEvent(t.authEvent)?"ACK":"ERROR"}}),gapi.iframes.CROSS_ORIGIN_IFRAMES_FILTER),this.eventManagers[e._key()]={manager:n},this.iframes[e._key()]=t,n}_isIframeWebStorageSupported(e,t){this.iframes[e._key()].send(cf,{type:cf},(n=>{var i;const r=null===(i=null==n?void 0:n[0])||void 0===i?void 0:i[cf];void 0!==r&&t(!!r),xu(e,"internal-error")}),gapi.iframes.CROSS_ORIGIN_IFRAMES_FILTER)}_originValidation(e){const t=e._key();return this.originValidationPromises[t]||(this.originValidationPromises[t]=qd(e)),this.originValidationPromises[t]}get _shouldInitProactively(){return bh()||uh()||gh()}};var hf="@firebase/auth",df="0.22.0";
/**
 * @license
 * Copyright 2020 Google LLC
 *
...
//# sourceMappingURL=index.56677258.js.map
