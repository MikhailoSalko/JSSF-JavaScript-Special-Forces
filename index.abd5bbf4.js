 ...
 * limitations under the License.
 */
function Pd(e,t){return t?Fu(t):(Mu(e._popupRedirectResolver,e,"argument-error"),e._popupRedirectResolver)}
/**
 * @license
 * Copyright 2019 Google LLC
 *
 ...
 * limitations under the License.
 */
const Wd="pendingRedirect",Hd=new Map;class $d extends zd{constructor(e,t,n=!1){super(e,["signInViaRedirect","linkViaRedirect","reauthViaRedirect","unknown"],t,void 0,n),this.eventId=null}async execute(){let e=Hd.get(this.auth._key());if(!e){try{const t=await async function(e,t){const n=Xd(t),i=Vd(e);if(!await i._isAvailable())return!1;const o="true"===await i._get(n);return await i._remove(n),o}(this.resolver,this.auth)?await super.execute():null;e=()=>Promise.resolve(t)}catch(t){e=()=>Promise.reject(t)}Hd.set(this.auth._key(),e)}return this.bypassAuthState||Hd.set(this.auth._key(),(()=>Promise.resolve(null))),e()}async onAuthEvent(e){if("signInViaRedirect"===e.type)return super.onAuthEvent(e);if("unknown"!==e.type){if(e.eventId){const t=await this.auth._redirectUserForId(e.eventId);if(t)return this.user=t,super.onAuthEvent(e);this.resolve(null)}}else this.resolve(null)}async onExecution(){}cleanUp(){}}function qd(e,t){Hd.set(e._key(),t)}function Vd(e){return Fu(e._redirectPersistence)}function Xd(e){return mh(Wd,e.config.apiKey,e.name)}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const nf=new qu(3e4,6e4);function of(){const e=yd().___jsl;if(null==e?void 0:e.H)for(const t of Object.keys(e.H))if(e.H[t].r=e.H[t].r||[],e.H[t].L=e.H[t].L||[],e.H[t].r=[...e.H[t].L],e.CP)for(let t=0;t<e.CP.length;t++)e.CP[t]=null}let rf=null;function sf(e){return rf=rf||function(e){return new Promise(((t,n)=>{var i,o,r;function s(){of(),gapi.load("gapi.iframes",{callback:()=>{t(gapi.iframes.getContext())},ontimeout:()=>{of(),n(Lu(e,"network-request-failed"))},timeout:nf.get()})}if(null===(o=null===(i=yd().gapi)||void 0===i?void 0:i.iframes)||void 0===o?void 0:o.Iframe)t(gapi.iframes.getContext());else{if(!(null===(r=yd().gapi)||void 0===r?void 0:r.load)){const t=Rd("iframefcb");return yd()[t]=()=>{gapi.load?s():n(Lu(e,"network-request-failed"))},Nd(`https://apis.google.com/js/api.js?onload=${t}`).catch((e=>n(e)))}s()}})).catch((e=>{throw rf=null,e}))}(e),rf}
/**
 * @license
 * Copyright 2020 Google LLC.
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const af=new qu(5e3,15e3),lf="__/auth/iframe",cf="emulator/auth/iframe",uf={style:{position:"absolute",top:"-100px",width:"1px",height:"1px"},"aria-hidden":"true",tabindex:"-1"},hf=new Map([["identitytoolkit.googleapis.com","p"],["staging-identitytoolkit.sandbox.googleapis.com","s"],["test-identitytoolkit.sandbox.googleapis.com","t"]]);function df(e){const t=e.config;Mu(t.authDomain,e,"auth-domain-config-required");const n=t.emulator?Vu(t,cf):`https://${e.config.authDomain}/${lf}`,i={apiKey:t.apiKey,appName:e.name,v:hr},o=hf.get(e.config.apiHost);o&&(i.eid=o);const r=e._getFrameworks();return r.length&&(i.fw=r.join(",")),`${n}?${uo(i).slice(1)}`}
/**
 * @license
 * Copyright 2020 Google LLC.
 *
